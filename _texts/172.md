...
<html><head><title>Euler - Problem 172</title>
...
<p><a href="http://projecteuler.net/problem=172" target="_blank">View Problem</a></p>
<pre>

COMMENTS:

Got this one on the first try. That rocks. I used dictionaries to track the progress as 
new digits were added. If a digit had reach its limit, then that digit was not added on. 
It took almost 4 minutes to run, but that's alright by me!
