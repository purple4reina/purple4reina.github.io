...
<html><head><title>Euler - Problem 64</title>
...
<p><a href="http://projecteuler.net/problem=64" target="_blank">View Problem</a></p>
<pre>
...
behind it, and knew how to go about getting the answer; but for some reason, 
it just never worked. Finally, I had the program test the first half of the 
...
high in order to compensate. This meant it took a little longer to run that 
I'd have liked, but it gave me the correct answer nonetheless.
